...
public class CreditApplicationApprovedEventReceiver {
    ...
    public void receiveMessage(CreditApplicationApprovedEvent creditApplicationApprovedEvent) {
        LOGGER.info("Received a CreditApplicationApprovedEvent for further processing: " + creditApplicationApprovedEvent.toString(), value("business_event", "CreditApplicationApprovedEvent"), value("type", "incoming_event"));
